...
def get_meaning(word: str) -> str:
    ...
    # For common words, provide meanings that don't contain the word itself
    COMMON_MEANINGS = {
        '天': '穹苍之上', '地': '脚下之处', '人': '受造之物', '神': '至高者',
        '河': '水流之处', '山': '高耸之地', '城': '人居住处', '国': '治理之地',
        '王': '统治之人', '民': '居住之人', '日': '光明显之时', '夜': '黑暗之时',
        '风': '空中之气', '雨': '天上之水', '火': '燃烧之物', '水': '生命之源',
        '石': '坚硬之物', '木': '生长之物', '田': '耕种之处', '路': '行走之处',
        '门': '出入之处', '殿': '敬拜之所', '家': '居住之所', '城': '聚集之处',
        '军': '争战之人', '兵': '打仗之人', '马': '奔跑之物', '车': '行走之器',
        '剑': '争战之器', '盾': '防身之器', '弓': '射箭之器', '箭': '飞射之物',
        '手': '做工之处', '眼': '观看之处', '耳': '听闻之处', '口': '说话之处',
        '心': '思想之处', '血': '生命之流', '肉': '身体之质', '骨': '支撑之架',
        '皮': '包裹之层', '发': '头上之毛', '齿': '咀嚼之具', '舌': '说话之具',
    }
